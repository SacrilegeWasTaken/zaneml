...
const __e = @import("../metal/engine.zig");
...
pub const MetalBackend = struct {
    pub fn forward(
        ...
        @panic("Metal backend not implemented yet");
    }
...
pub const MetalLayerNorm = struct {
    pub fn forward(
        ...
        @panic("Metal LayerNorm not implemented yet");
    }
    pub fn backward(
...
pub const MetalOptimizer = struct {
    pub fn update(
        ...
        @panic("Metal Optimizer not implemented yet");
    }
};
...
pub const MetalLoss = struct {
    pub fn mse(output: []const f32, target: []const f32, grad_out: []f32, inv: f32) f32 {
        ...
        @panic("Metal Loss not implemented yet");
    }
...
pub const MetalRMSNorm = struct {
    pub fn forward(
        ...
        @panic("Metal RMSNorm not implemented yet");
    }
    pub fn backward(
...
pub const MetalPositionalEmbedding = struct {
    pub fn forward(input: []const f32, output: []f32, embed: []const f32) void {
        ...
        @panic("Metal PositionalEmbedding not implemented yet");
    }
...
pub const MetalEmbedding = struct {
    pub fn forward(d_model: usize, indices: []const u32, output: []f32, table: []const f32) void {
        ...
        @panic("Metal Embedding not implemented yet");
    }
...
pub const MetalDropout = struct {
    pub fn forward(
        ...
        @panic("Metal Dropout not implemented yet");
    }
...
pub const MetalAttention = struct {
    pub fn forward(
        ...
        @panic("Metal Attention not implemented yet");
    }
    pub fn backward(
