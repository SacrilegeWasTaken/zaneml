...
pub const CudaLayerNorm = struct {
    pub fn forward(
        ...
        @panic("CUDA LayerNorm not implemented yet");
    }
    pub fn backward(
...
pub const CudaOptimizer = struct {
    pub fn update(
        ...
        @panic("CUDA Optimizer not implemented yet");
    }
};

pub const CudaLoss = struct {
    pub fn mse(output: []const f32, target: []const f32, grad_out: []f32, inv: f32) f32 {
        _ = .{ output, target, grad_out, inv };
        @panic("CUDA Loss not implemented yet");
    }
...
pub const CudaPositionalEmbedding = struct {
    pub fn forward(input: []const f32, output: []f32, embed: []const f32) void {
        _ = .{ input, output, embed };
        @panic("CUDA PositionalEmbedding not implemented yet");
    }
...
pub const CudaDropout = struct {
    pub fn forward(
        ...
        @panic("CUDA Dropout not implemented yet");
    }
...
pub const CudaAttention = struct {
    pub fn forward(
        ...
        @panic("CUDA Attention not implemented yet");
    }
    pub fn backward(
