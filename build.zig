...
pub fn build(b: *std.Build) void {
    ...
    const tape_transformer_exe = addExample(b, "tape-transformer", "examples/tape_transformer.zig", target, optimize, example_imports);
    ...
    addRunStep(b, tape_transformer_exe, "tape-transformer", "Run examples/tape_transformer.zig (TapeTransformerStack benchmark)");
